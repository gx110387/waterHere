...
- (void) H_data
{
    ...
    [[TourDataTool shareData] getSingleDictWithURL:[NSString stringWithFormat:@"http://api.breadtrip.com/place/pois/nearby/?category=0&start=0&count=20&latitude=%f&longitude=%f",self.latitude,self.longitude] PassValue:^(NSDictionary *dict) {
