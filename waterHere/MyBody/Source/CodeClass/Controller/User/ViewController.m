...
//  MyBody
//
//  Created by gx110387 on 15/11/8.
...
- (void)viewDidLoad {
    ...
    scroll.contentSize = CGSizeMake(MainScreenWidth, [GGxTools G_heightForString:s num:14 width:MainScreenWidth-20]);
    ...
    UILabel * laber = [[UILabel alloc] initWithFrame:CGRectMake(10,CGRectGetMaxY(backImage.frame),CGRectGetWidth(self.view.frame)-20, [GGxTools G_heightForString:s num:14 width:MainScreenWidth-20])];
